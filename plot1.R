...
##START 
## Creating plot 1 & and changing margins to fit screen device
hist(twoday$Global_active_power, main="Global Active Power", xlab = "Global Active Power (kilowatts)", col="red")
par(mar = c(2,2,2,2))

## Saving plot 1 as png with width and height = 480 pixels
